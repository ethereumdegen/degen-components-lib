...
const NavigationMenu = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(NavigationMenuPrimitive.Root, Object.assign({ ref: ref, className: (0, utils_1.cn)("relative z-10 flex flex-1 items-center justify-center", className) }, props),
        children,
