...
const ContextMenuSubContent = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(ContextMenuPrimitive.SubContent, Object.assign({ ref: ref, className: (0, utils_1.cn)("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in slide-in-from-left-1", className) }, props)));
});
...
const ContextMenuContent = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(ContextMenuPrimitive.Portal, null,
        React.createElement(ContextMenuPrimitive.Content, Object.assign({ ref: ref, className: (0, utils_1.cn)("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-80", className) }, props))));
});
