...
const AlertDialogPortal = (_a) => {
    ...
    return (React.createElement(AlertDialogPrimitive.Portal, Object.assign({ className: (0, utils_1.cn)(className) }, props),
...
const AlertDialogOverlay = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
    return (React.createElement(AlertDialogPrimitive.Overlay, Object.assign({ className: (0, utils_1.cn)("fixed inset-0 z-50 bg-background/80 backdrop-blur-sm transition-opacity animate-in fade-in", className) }, props, { ref: ref })));
});
